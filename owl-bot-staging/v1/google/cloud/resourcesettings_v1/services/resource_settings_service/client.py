...
class ResourceSettingsServiceClientMeta(type):
    """Metaclass for the ResourceSettingsService client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ResourceSettingsServiceTransport]]
...
class ResourceSettingsServiceClient(metaclass=ResourceSettingsServiceClientMeta):
    ...
    def transport(self) -> ResourceSettingsServiceTransport:
        ...
        Returns:
            ResourceSettingsServiceTransport: The transport used by the client
                instance.
        """
    ...
    def setting_path(project_number: str,setting_name: str,) -> str:
        ...
        return "projects/{project_number}/settings/{setting_name}".format(project_number=project_number, setting_name=setting_name, )
    ...
    def list_settings(self,
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_settings]
