...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceRestTransport, "rest", "true"),
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceRestTransport, "rest", "false"),
])
@mock.patch.object(ResourceSettingsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ResourceSettingsServiceClient))
@mock.patch.object(ResourceSettingsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ResourceSettingsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    ResourceSettingsServiceClient, ResourceSettingsServiceAsyncClient
])
@mock.patch.object(ResourceSettingsServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ResourceSettingsServiceClient))
@mock.patch.object(ResourceSettingsServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ResourceSettingsServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceGrpcTransport, "grpc", grpc_helpers),
    (ResourceSettingsServiceAsyncClient, transports.ResourceSettingsServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceRestTransport, "rest", None),
])
...
async def test_list_settings_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_settings(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_settings_rest_interceptors(null_interceptor):
    transport = transports.ResourceSettingsServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.ResourceSettingsServiceRestInterceptor(),
        )
    client = ResourceSettingsServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "post_list_settings") as post, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "pre_list_settings") as pre:
...
def test_get_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "post_get_setting") as post, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "pre_get_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_setting_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "post_update_setting") as post, \
         mock.patch.object(transports.ResourceSettingsServiceRestInterceptor, "pre_update_setting") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
@pytest.mark.parametrize("client_class,transport_class", [
    (ResourceSettingsServiceClient, transports.ResourceSettingsServiceGrpcTransport),
    (ResourceSettingsServiceAsyncClient, transports.ResourceSettingsServiceGrpcAsyncIOTransport),
])
